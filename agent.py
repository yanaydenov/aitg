...
def _system_prompt(ctx: tools.ToolCtx) -> str:
    ...
    parts = [
        ...
        "Стиль ответов: разговорный но конструктивный. Отвечай по сути, без воды и филлеров вроде 'забей', 'короче', 'ну', 'типа', 'кста', 'кмк'. Не сокращай слова до жаргонизмов. Можно живо, но содержательно — каждое предложение должно нести информацию. Используй язык последнего вопроса.",
