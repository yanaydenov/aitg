...
- Понимание голосовых сообщений (конвертация в mp3 → Gemini audio)
- Чтение истории текущего и других чатов, фильтр по периоду (`since_hours`)
- Поиск сообщений по тексту по всем чатам
- Курсы валют, крипто, погода
- Просмотр профилей пользователей (аватарка передаётся в vision)
- Напоминания: `напомни через 30 минут ...` / `напомни завтра в 12 ...`
- Долгосрочная память: per-chat, глобальная, per-user
- Полный лог всех диалогов с поиском (`search_log`)
